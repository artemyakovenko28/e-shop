...
import static com.company.eshop.inject.ApplicationContextHolder.getClasspathXmlApplicaionContext;
...
public class DependencyInjectionServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        try {
            // load AppContext
            ApplicationContext appCtx = getClasspathXmlApplicaionContext(appCtxPath);
